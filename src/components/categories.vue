<template>
  <div
    id="categories"
    class="mt-56 flex h-screen flex-col items-center justify-center gap-6 bg-linear-to-b from-[#080A0A] to-[#240000] pb-96 md:mt-0 md:pb-44"
  >
...
import bossesImg from '@/public/bosses.jpg'
import weaponsImg from '@/public/weapons.jpg'
import itemsImg from '@/public/items.jpg'
